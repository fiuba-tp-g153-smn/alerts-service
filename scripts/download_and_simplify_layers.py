...
COUNTRY_GEOJSON_URL = f"{IGN_BASE_URL}?service=WFS&version=1.0.0&request=GetFeature&typeName=ign:pais&outputFormat=application/json"
DEPARTMENTS_GEOJSON_URL = f"{IGN_BASE_URL}?service=WFS&version=1.0.0&request=GetFeature&typeName=ign:departamento&outputFormat=application/json"
